...
class JSONFunkinSprite {
    ...
    @:default(1) @:optional public var scale : Float;
    ...
    @:default(0.9) @:optional public var scrollFactorX : Float;
    @:default(0.9) @:optional public var scrollFactorY : Float;
    @:default(1) @:optional public var camzoom : Float;
    public function new() {}
    ...
    public function convertToBeatSprite() : BeatSprite {
        ...
        beatsprite.scrollFactor.set(scrollFactorX, scrollFactorY);
        beatsprite.scale.set(scale, scale);
        ...
        if (animation != null) {
            ...
            beatsprite.loadGraphic(BitmapData.fromFile(graphicpath + graphic + ".png"));
            trace(graphicpath + graphic + ".png");
        }
        trace("checked anims");
        beatsprite.antialiasing = antialiasing;
        beatsprite.graphicpath = graphicpath;
        trace('checked extra shit');
        return beatsprite;
    }
